...
# thermal_decay oldingi, endi yangi beta slayderlar bilan almashtirildi
# beta_thermal  = st.sidebar.number_input(t('thermal_decay'), value=0.0035, format="%.4f") # o'chirildi
